...
- ===
- Okay after all that rambling, I've started training with FID and clip. Speeds are pretty much the same, however extra 2min per epoch for fid calculation (negligible). We'll see how this goes, and of course I'm going to have to go through about 3 days of training time. RAM use is up, 35gb rather than like 20 (7f1e092)
